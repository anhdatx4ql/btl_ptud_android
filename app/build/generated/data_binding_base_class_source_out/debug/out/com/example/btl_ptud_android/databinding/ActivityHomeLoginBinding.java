...
public final class ActivityHomeLoginBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityHomeLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityHomeLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_home_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityHomeLoginBinding bind(@NonNull View rootView) {
